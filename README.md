...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/supply--chain-finance-orange.svg" alt="Topic">
...
**Inflation Cost Escalation** addresses a critical challenge in modern supply chain management: cost management. This implementation combines rigorous academic methodology with production-ready Python code, suitable for both research and enterprise deployment.
...
```bash
git clone https://github.com/virbahu/inflation-cost-escalation.git
cd inflation-cost-escalation
pip install -r requirements.txt
python inflation_cost_escalation.py
```
...
```python
# Quick start example
from inflation_cost_escalation import *
...
# See docstrings in inflation_cost_escalation.py for full parameter reference
```
